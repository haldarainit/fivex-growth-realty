...
export const leadershipMembers: LeadershipMember[] = [
  {
    ...
    department: 'founder',
    shortBio: 'Founder & CEO of FiveX Growth Realty Pvt. Ltd, specializing in residential, commercial, plotted developments and industrial leasing with 15+ years of expert advisory across Noida, Greater Noida and Yamuna Expressway.',
  ...
  },
  {
    ...
    image: '/Bashir%20Uddin.jpeg',
    imageAlt: 'Mr. Mohammad Bashiruddin, Director',
    phone: '+91 8279319964',
    whatsapp: 'https://wa.me/message/JWVTANEKZ55YB1',
    email: 'infofivexgrowthrealty@gmail.com',
    website: 'www.fivexgrowthrealty.com',
    linkedin: 'https://www.linkedin.com/in/bashiruddin-asad-b30b421b9?utm_source=share_via&utm_content=profile&utm_medium=member_android',
    social: [
      { platform: 'LinkedIn', url: 'https://www.linkedin.com/in/bashiruddin-asad-b30b421b9?utm_source=share_via&utm_content=profile&utm_medium=member_android' },
      { platform: 'Facebook', url: 'https://www.facebook.com/share/1DHFoPehNu/' },
      { platform: 'Instagram', url: 'https://www.instagram.com/bashiruddin91?igsh=MTBqcG44NDczdXU0eg==' },
      { platform: 'WhatsApp', url: 'https://wa.me/message/JWVTANEKZ55YB1' },
    ],
    fullBio: [
